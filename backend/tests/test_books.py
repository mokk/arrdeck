...
from app.api.v1.books import author_map, book_cover, book_row, year_of
...
def test_history_events_use_readarrs_names_and_carry_the_book_id():
    ...
    payload = {
        "records": [
            {"id": 1, "downloadId": "abc", "sourceTitle": "rel", "date": "2026-09-22T20:00:00Z",
             "eventType": "grabbed", "bookId": 133},
            {"id": 2, "downloadId": "abc", "sourceTitle": "rel", "date": "2026-09-22T20:17:00Z",
             "eventType": "bookImportIncomplete", "bookId": 133},
        ]
    }
